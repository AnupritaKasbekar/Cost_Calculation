...
/*importmaterialcosts*/
useEffect(()=>{
    axios.get("http://localhost:3001/import/sum_raw_mat23").then((response)=>{
...
useEffect(()=>{
    axios.get("http://localhost:3001/department_expense/sum_sal_var23").then((response)=>{
...
/*importmaterialcosts*/
useEffect(()=>{
    axios.get("http://localhost:3001/import/out_acc23").then((response)=>{
...
/*importmaterialcosts*/
useEffect(()=>{
    axios.get("http://localhost:3001/import/final_stk23").then((response)=>{
...
/*importmaterialcosts*/
useEffect(()=>{
    axios.get("http://localhost:3001/import/am23").then((response)=>{
...
/*departmental expense*/
useEffect(()=>{
    axios.get("http://localhost:3001/department_expense/23").then((response)=>{
...
/*importmaterialcosts*/
useEffect(()=>{
    axios.get("http://localhost:3001/import/s23").then((response)=>{
...
/*importmaterialcosts*/
useEffect(()=>{
    axios.get("http://localhost:3001/import/o23").then((response)=>{
...
console.log("sum_basic_stk: "+sum_basic_stock);
console.log("sum_in_optn: "+sum_in_optn);
console.log("sum_in_purch: "+sum_in_purch);
console.log("sum_out_cst: "+sum_out_cst);

const raw_mat_ss = sum_basic_stock+sum_in_optn+sum_in_purch-sum_out_cst-sumout_account_sum;
...
let c_sum = sum_basic_stoc + sum_in_purchas - sum_out_cost_ra -sum_out_accoun;
c_sum = c_sum*2000
...
const busins_fix_cost = list_man_hr_product.map(sum_b=>sum_b.business_fixed_costs).reduce((a,b)=>a+b,0);
const comn_fixed_cost =  list_man_hr_product.map(sum_b=>sum_b.common_fixed_cost).reduce((a,b)=>a+b,0)
const raw_mat_sum = raw_mat.map(sum_pruchase=>sum_pruchase.sum_in_purchase).reduce((a,b)=>a+b,0)
...
const rnd_tot = busins_fix_cost+comn_fixed_cost;
...
const man_pro_tot= rnd_tot+depreciation_sum_sum+total_fix_var_waste_disposal_cost_sum+elec_fix_var_tot_cost_sum+benefit_tot_sum+payment_tot_sum+repair_total_sum+fuel_dir_cost_sum+consumable_sum_sum+tax_total_sum+insurance_tot_sum+water_utility_tot_sum+education_fee_sum+vechicle_maint_cost_sum+book_print_fee_sum+teavel_expense_tot_sum+enteritainment_fee_sum+communitaction_cost_sum+rent_tot_sum+transport_tot_sum+65014998;
...
const l_r = wip_stk-sum_carr_ovr;
  ...
  return (
    <div className='App'>
      ...
      <table id="empTablesum" className=''>
      <thead className=''>
            <tr className=''>
          ...
          <tr>
            ...
            <td className='q2'></td>
            <td className='textright'>{(6197046031+raw_mat_sum-raw_mat_option_sum-raw_mat_ss).toLocaleString("ko-KR",{ minimumFractionDigits: 0,maximumFractionDigits: 0} )}</td>
          ...
          <tr>
            ...
            <td className='textright'>6,197,046,031</td>
          ...
          <tr>
            <td>타계정에서 대체액</td>{/* <span className='text-success'></span> Raw_material/material_cost Option*/}
              <td>    Transfer from another accoun</td>
            <td className='textright'> {raw_mat_option_sum.toLocaleString("ko-KR",{ minimumFractionDigits: 0,maximumFractionDigits: 0} )}</td>
            <td className='textright'></td>
          ...
          <tr>
            <td>타계정으로 대체액</td>{/* <span className='text-success'>(Option)Raw_material/materail_cost]</span>*/}
              <td >    Transfer to another accoun</td>
            <td className='textright'>0</td>
            <td className='textright'></td>
          </tr>
          <tr>
        ...
        <tr>
            <td>급료와임금(공장){/*<span className='text-success'>Salary</span>*/}</td>
       ...
       {/*     <td className='textright'>{(594783121-rp_expense).toLocaleString("ko-KR",{ minimumFractionDigits: 0,maximumFractionDigits: 0} )}</td>*/}
        ...
        <tr>
            <td>연구개발비{/*} <span className='text-success'>(R&D expenses)</span>*/}</td>
             <td>R&D</td>
            <td className='textright'>{rnd_tot.toLocaleString("ko-KR",{ minimumFractionDigits: 0,maximumFractionDigits: 0})}</td>
            <td></td>
       ...
       {/*     <td className='textright'>{(3562086744-depreciation_sum_sum).toLocaleString("ko-KR",{ minimumFractionDigits: 0,maximumFractionDigits: 0})}</td>    */}
        ...
        <tr>
            ...
            <td className='textright'>{(total_fix_var_waste_disposal_cost_sum+ 37013340).toLocaleString("ko-KR",{ minimumFractionDigits: 0,maximumFractionDigits: 0})}</td>
            <td></td>
        ...
        <tr>
            <td>전력비 {/*<span className='text-success'>(Electricity cost)</span>*/}</td>
             <td>      Electricity</td>
            <td className='textright'>{(elec_fix_var_tot_cost_sum+ 16980571).toLocaleString("ko-KR",{ minimumFractionDigits: 0,maximumFractionDigits: 0})}</td>
            <td></td>
        ...
        <tr>
            ...
            <td>Fees</td>
            <td className='textright'>{(payment_tot_sum+7244720).toLocaleString("ko-KR",{ minimumFractionDigits: 0,maximumFractionDigits: 0} )}</td>
            <td></td>
        ...
        <tr>
            ...
            <td className='textright'>{(repair_total_sum+ 1340001).toLocaleString("ko-KR",{ minimumFractionDigits: 0,maximumFractionDigits: 0} )}</td>
            <td></td>
        ...
        <tr>
            <td>연료비{/*} <span className='text-success'>(Annual fee)</span>*/}</td>
             <td>Fuel</td>
            <td className='textright'>{(fuel_dir_cost_sum+ 1579963).toLocaleString("ko-KR",{ minimumFractionDigits: 0,maximumFractionDigits: 0} )}</td>
            <td></td>
        ...
        <tr>
            ...
            <td className='textright'>{(consumable_sum_sum+ 360001).toLocaleString("ko-KR",{ minimumFractionDigits: 0,maximumFractionDigits: 0} )}</td>
            <td></td>
        ...
        <tr>
            <td>수도광열비 {/*} <span className='text-success'>(Water and utilities )</span>*/}</td>
             <td>Water and gas</td>
            <td className='textright'>{(water_utility_tot_sum+ 496403).toLocaleString("ko-KR",{ minimumFractionDigits: 0,maximumFractionDigits: 0} )}</td>
            <td></td>
        ...
        <tr>
            ...
            <td>Ⅷ. Ending work in process  </td>
            <td className='q2'></td>
        ...
        <tr>
            <td className='text-primary'><b><ul>Ⅸ.타계정으로 대체액</ul></b></td>
             <td>Ⅸ. Transfer to other accounts</td>
            <td className='q2'></td>
            <td className='textright'>0</td>
        {/*    <td className='textright'>0</td>*/}
...
export default SummeryReport23
