...
function Raw_package_material_cost() {
    const[listRaw_pack_cost, setlistRaw_pack_cost] = useState([])
    useEffect(()=>{
        axios.get("http://localhost:3001/raw_pack/22").then((response)=>{
...
export default Raw_package_material_cost
